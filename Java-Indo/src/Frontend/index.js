        ...
        <div className="w-screen overflow-x-hidden lg:pt-64 2xl:pt-8">
            ...
            <section className="container mx-auto my-4">
                <div className="flex flex-col justify-center">
                    ...
                    <p className="font-regular text-xl text-center mx-auto w-4/5 sm:w-3/6">Kualitas Produk : Komoditi Premium, Komoditi Sedang, Komoditi Standar</p>
                </div>
            </section>
            {/* Card */}
            ...
            <section className="container mx-auto mt-24 mb-12">
                <div className="w-full grid grid-cols-1 lg:grid-cols-2">
                    <div className="w-5/6 py-24 ml-14 text-left">
                        <h1 className="text-blue-900 font-bold text-3xl w-3/5 leading-normal"><span className="text-yellow-500">Komitmen</span> untuk Memberikan Kualitas Terbaik</h1>
            ...
            <section className="container mx-auto mt-24 mb-12">
                <div className="flex flex-col">
                    ...
                    <div className="flex justify-end mr-16">
                        <h1 className="text-3xl sm:text-4xl text-blue-800 font-bold">Ini Adalah Produk Terbaik Kami </h1>
                    </div>
                    {/* box */}
                    <Splide options={{
                        rewind: true,
                        ...
                        <SplideSlide>
                            <div className="flex justify-center lg:p-16 p-0 mt-8 ">
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    ...
                                    <div class="px-6 py-4">
                                        <div class="font-bold text-xl mb-2">Kelas A</div>
                                        <p class="text-gray-700 text-base">
                                            Material 100 % Briket arang kelapa, Nilai Kalori 7000-7200 Kilo kalori, Jumlah Kelembapan 7%, mengandung abu 2% dan Abu Putih, Karbon tetap 80% - 85%
                                        </p>
                                    </div>
                                    <div class="px-6 pt-4 pb-2">
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Kotak Induk Termasuk</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Disesuaikan</span>
                                    </div>
                                </div>
                            </div>
                        </SplideSlide>
                            ...
                            <div className="flex justify-center lg:p-16 p-0 mt-8 ">
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    ...
                                    <div class="px-6 py-4">
                                        ...
                                        <p class="text-gray-700 text-base">
                                            Material 100 % Arang batok kelapa, Nilai Kalori sekitar 7000 kilo kalori, Abu putih dan berisi 2.5%, Karbon Tetap 80%
                                        </p>
                                    </div>
                                    <div class="px-6 pt-4 pb-2">
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Ukuran 3.5x2.5x2.5cm</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Ukuran 3x3x3cm</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Ukuran 2.5x2.5x5cm</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Bisa Disesuaikan</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Paket Master Box 10kg termasuk</span>
                                    </div>
                                </div>
                            </div>
                        </SplideSlide>
                        <SplideSlide>
                            <div className="flex justify-center lg:p-16 p-0 mt-8 ">
                                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                                    ...
                                    <div class="px-6 py-4">
                                        <div class="font-bold text-xl mb-2">Standar</div>
                                        <p class="text-gray-700 text-base">
                                            Material 80% kelapa 20% arang kelapa granular, Nilai kalori sekitar 6500-7000 kilo kalori, Kelembapan total 7-10%, Abu putih dan berisi 4-5%, Karbon Tetap 75%
                                        </p>
                                    </div>
                                    <div class="px-6 pt-4 pb-2">
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Ukuran 2.5x2.5x2.5cm</span>
                                        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Dapat Disesuaikan</span>
                                    </div>
                                </div>
                            </div>
                        </SplideSlide>
            ...
            <section className="container mx-auto mt-24 mb-12">
                <div className="flex flex-col justify-center">
                    <h1 className="font-bold text-3xl text-blue-800 text-center">Anda dapat menghubungi kami!</h1>
                    ...
                    <div className="flex flex-row justify-center mt-6">
                        ...
                        <button className="bg-blue-800 rounded-full px-5 py-2 text-white font-semibold w-32">Kirim</button>
                    </div>
                </div>
            </section>
            {/* Contact */}
