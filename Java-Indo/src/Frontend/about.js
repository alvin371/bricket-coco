        ...
        <div className="pt-32 w-screen overflow-x-hidden">
                        ...
                        <SplideSlide>
                            <div class="navbar">
                                <div class="w-4/5 sm:max-w-lg text-left absolute left-11 md:left-32 md:top-24 sm:top-20 top-2 bg-gray-50 bg-opacity-90 shadow-lg md:p-5 p-2 rounded-lg">
                                    ...
                                    <button
                                        class="w-full px-8 sm:py-4 py-2 sm:mt-6 mt-2 text-xs font-medium text-white uppercase transition-colors duration-200 transform bg-yellow-500 rounded-full lg:w-auto hover:bg-yellow-500 focus:outline-none focus:bg-indigo-500">Belanja Sekarang</button>
                                </div>
            ...
            <section className="container mx-auto my-10">
                <div className="flex flex-col">
                    <div className>
                        <h1 className="font-bold text-4xl text-center mb-10">Kami Terdaftar Di</h1>
                    </div>
            ...
            <section className="container mx-auto mt-24 mb-12">
                <div className="flex flex-row justify-center">
                    ...
                    <div className="lg:w-1/2 md:w-3/4 w-5/6">
                        <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white">Berhubungan</h2>
                        ...
                        <div className="mt-6 ">
                            ...
                            <div className="flex justify-center mt-6">
                                <button className="px-4 py-2 text-white transition-colors duration-200 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Kirim Pesan</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:flex lg:justify-start lg:mr-24 mr-0">
                    ...
                    <div className="flex lg:justify-center justify-center w-full lg:w-5/12 pt-8">
                        <table className="border-0 text-left text-xs sm:text-base">
                            <tbody><tr>
                                <td className="px-4">Kantorm Utama</td>
