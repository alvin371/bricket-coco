    ...
    return (
        <div className="pt-24 w-screen overflow-x-hidden">
            ...
            <section className="container mx-auto mt-12 mb-12 ml-8 sm:ml-4 md:ml-12 lg:ml-12 xl:ml-20 2xl:ml-52">
                <h1 className="font-bold text-2xl text-yellow-400"><Link to="/" className="no-underline mr-5">Beranda</Link>/<span className="text-blue-900 ml-5">Produk Kami</span></h1>
                <hr className="w-2/12" />
            </section>
            {/* button */}
            ...
            <section className="container mx-auto mt-24 mb-12">
                <div className="grid grid-flow-row grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 m-5">
                    ...
                    <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm mb-5">
                        ...
                        <div className="p-5">
                            <p className="inline-flex cursor-pointer" onClick={() => setModal( true )}>
                                <h5 className="text-gray-900 font-bold text-xl sm:text-2xl tracking-tight mb-2">Kelas A</h5>
                            </p>
                            <p className="font-normal text-gray-700 mb-3"> Material 100 % Briket arang kelapa, Nilai Kalori 7000-7200 Kilo kalori, Jumlah Kelembapan 7%, mengandung abu 2% dan Abu Putih, Karbon tetap 80% - 85%
            ...
            <section className="container mx-auto mt-12 mb-12">
                <div className="flex flex-col justify-center">
                    <h1 className="font-bold text-2xl text-center">Bricket Kualitas Premium</h1>
